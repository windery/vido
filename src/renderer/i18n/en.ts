...
export const en = {
  ...
  mode: {
    ...
    configSchedule: '-- SCHEDULE -- (j/k nav ⏎ select · 1/2/3 quick · dd clear)',
    configScheduleEdit: '-- SCHEDULE-EDIT -- (type date, Enter save, Esc cancel)',
    configPriority: '-- PRIORITY -- (j/k nav ⏎ select · 1/2/3 quick · dd clear)',
  ...
  config: {
    ...
    add: 'Add',
    footer: '<kbd>H</kbd><kbd>L</kbd> sections · <kbd>j</kbd><kbd>k</kbd> nav <kbd>⏎</kbd> select · <kbd>Esc</kbd> exit',
  },
  content: {
    ...
    sections: [
      ...
      },
      {
        ...
        commands: [
          ...
          { key: 'j / k', desc: 'Navigate options (highlight only, nothing applied) — Enter selects the highlighted one' },
          { key: '1 / 2 / 3', desc: 'Quick select without navigating (priority/schedule)' },
          { key: 'dd', desc: 'Clear current item (schedule/priority/all tags)' },
