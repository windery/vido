...
export const en = {
  ...
  mode: {
    ...
    configSchedule: '-- SCHEDULE -- (j/k cycle · 1/2/3 quick · dd clear ⏎ custom)',
    configScheduleEdit: '-- SCHEDULE-EDIT -- (type date, Enter save, Esc cancel)',
    configPriority: '-- PRIORITY -- (j/k cycle · 1/2/3 quick · dd clear)',
    configTags: '-- TAGS -- (⏎ add dd clear d+index+⏎ delete)',
  ...
  config: {
    ...
    add: 'Add',
    footer: '<kbd>H</kbd><kbd>L</kbd> sections · <kbd>j</kbd><kbd>k</kbd> cycle value · <kbd>Esc</kbd> exit',
  },
  content: {
    ...
    sections: [
      ...
      },
      {
        ...
        commands: [
          ...
          { key: 'j / k', desc: 'Cycle value: schedule today→tomorrow→next week, priority none→!→!!→!!!' },
