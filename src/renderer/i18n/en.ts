...
export const en = {
  ...
  mode: {
    ...
    configTags: 'j k nav · ⏎ add · d n ⏎ delete · x clear · ? keys',
  ...
  help: {
    ...
    sections: [
      ...
      },
      {
        ...
        notes: ['Common: H/L switch section · cs/cp/ct jump · cc toggle panel'],
      },
      {
      ...
      },
      {
        ...
        scope: 'config-tags',
        commands: [
          { key: 'j / k', desc: 'Navigate options (tags → add → clear)' },
          { key: '0 / $', desc: 'Jump to first / last option' },
          { key: 'Enter', desc: 'Select highlighted / open tag input' },
          { key: 'd + index + ⏎', desc: 'Delete tag by number' },
          { key: 'x', desc: 'Clear all tags (highlighted tag → delete that tag)' },
        ],
        notes: ['Common: H/L switch section · cs/cp/ct jump · cc toggle panel'],
      },
    ] as HelpSection[],
